...
public class RouteViewAdapter extends RecyclerView.Adapter<RouteViewAdapter.MyViewHolder> {
    ...
    public RouteViewAdapter(Context context, HistoryFromTo fromTo, ArrayList<Station> stationArrayList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (stationCode.equals(fromCode)) {
            holder.trackMedium.setBackgroundResource(R.drawable.top);
        } else if (stationCode.equals(toCode)) {
